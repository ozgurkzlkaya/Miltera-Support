      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, md: 8 }}>
          ...
          <Typography variant="body1" sx={{ opacity: 0.9 }}>
            Miltera Teknik Servis Portalı'na hoş geldiniz. Ürünlerinizi takip edin, arıza kayıtlarını görüntüleyin ve destek alın.
          </Typography>
          <Typography variant="body2" sx={{ opacity: 0.8, mt: 1 }}>
            Üye olduğunuz tarih: {new Date(customerInfo.memberSince).toLocaleDateString("tr-TR")}
          </Typography>
        </Grid>
        <Grid size={{ xs: 12, md: 4 }} sx={{ textAlign: "center" }}>
          <Avatar sx={{ width: 80, height: 80, margin: "0 auto", bgcolor: "rgba(255,255,255,0.2)" }}>
